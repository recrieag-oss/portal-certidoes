    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm">
          {/* Header */}
          <div className="relative border-b border-slate-100 px-8 pb-6 pt-8 text-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-5 px-8 py-8">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full rounded-[16px] border border-slate-200 bg-slate-50 px-4 py-3.5 text-sm text-slate-900 outline-none transition focus:border-[#009B3A] focus:ring-2 focus:ring-[#009B3A]/10"
              />
            </div>
            ...
            <div className="flex justify-end">
              <Link
                ...
                className="text-xs font-medium text-[#009B3A] hover:underline"
              >
                Esqueceu a senha?
              </Link>
            </div>
            ...
            <div className="flex items-center gap-2 rounded-[14px] bg-slate-50 px-4 py-3">
              ...
              <p className="text-xs text-slate-500">
                ...
                <Link
                  ...
                  className="font-semibold text-[#009B3A] hover:underline"
                >
                  Solicitar agora
                </Link>
              </p>
