  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-10 sm:px-8 sm:py-14">
      <div className="mb-6 max-w-2xl sm:mb-8">
        ...
        <h1 className="mt-3 text-2xl font-semibold tracking-tight text-slate-950 sm:text-3xl lg:text-4xl">
          Revise seu pedido e conclua o pagamento
        </h1>
        <p className="mt-3 text-sm leading-6 text-slate-600">
          Confira os dados abaixo e finalize o pagamento com segurança.
        </p>
      </div>
      <div className="grid items-start gap-6 sm:gap-8 lg:grid-cols-[minmax(0,1.15fr)_380px]">
        <OrderSummary />
        <MercadoPagoCheckout />
      </div>
    </main>
